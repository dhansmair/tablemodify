...
"use strict";function hasClass(e,t){return e.classList?e.classList.contains(t):new RegExp("\\b"+t+"\\b").test(e.className)}function id2index(e){var t=document.querySelector("thead > tr > *[tm-id="+e+"]");return t?[].indexOf.call(t.parentNode.children,t):null}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},config=require("./config.js");exports.log=function(e){config.debug&&console.log("tm-log: "+e)},exports.info=function(e){config.debug&&console.info("tm-info: "+e)},exports.warn=function(e){config.debug&&console.warn("tm-warn: "+e)},exports.trace=function(e){config.debug&&console.trace("tm-trace: "+e)},exports.error=function(e){console.error("tm-error: "+e)},exports.errorThrow=function(e){throw exports.error(e),new Error(e)},exports.hasClass=hasClass,exports.addClass=function(e,t){return e.classList?e.classList.add(t):hasClass(e,t)||(e.className+=" "+t),e},exports.removeClass=function(e,t){return e.classList?e.classList.remove(t):e.className=e.className.replace(new RegExp("\\b"+t+"\\b","g"),""),e},exports.elementIndex=function(e){try{for(var t=0;e=e.previousElementSibling;)t++;return t}catch(e){return-1}},exports.extend=function e(t){for(var r=arguments.length,o=Array(r>1?r-1:0),n=1;n<r;n++)o[n-1]=arguments[n];for(var s=function(r){var n=o[r];Object.keys(n).forEach(function(r){if({}.hasOwnProperty.call(t,r)){var o=_typeof(t[r]),s=_typeof(n[r]);o!==s||"object"!==o&&"function"!==o||e(t[r],n[r])}else t[r]=n[r]})},i=0;i<o.length;i++)s(i);return t},exports.iterate=function(e,t){if("object"===("undefined"==typeof e?"undefined":_typeof(e)))for(var r=Object.keys(e),o=r.length,n=0;n<o;n++)t(r[n],e[r[n]]);else for(var s=e.length,i=0;i<s;i++)t(e[i],i)},exports.isNonEmptyString=function(e){return"string"==typeof e&&e.trim().length>0};var isObj=exports.isObject=function(e){return"object"===("undefined"==typeof e?"undefined":_typeof(e))};exports.isFn=function(e){return"function"==typeof e},exports.isBool=function(e){return"boolean"==typeof e},exports.isNumber=function(e){return"number"==typeof e&&!isNaN(e)};var getProp=exports.getProperty=function(e){for(var t=arguments.length,r=Array(t>1?t-1:0),o=1;o<t;o++)r[o-1]=arguments[o];if(isObj(e)&&0!==r.length){for(var n=0;n<r.length-1;){if(e=e[r[n]],!isObj(e))return;++n}if(void 0!==e[r[n]])return e[r[n]]}};exports.hasProp=function(e){for(var t=arguments.length,r=Array(t>1?t-1:0),o=1;o<t;o++)r[o-1]=arguments[o];return void 0!==getProp.apply(void 0,[e].concat(r))},exports.replaceIdsWithIndices=function(e){return Object.keys(e).forEach(function(t){if("all"!==t&&isNaN(t)){var r=id2index(t);null!=r&&(e[r]=e[t],delete e[t])}}),e},exports.cloneArray=function(e){for(var t=[],r=e.length;r--;)t[r]=e[r];return t},exports.delay=function(){var e=400,t=void 0;return function(r){window.clearTimeout(t),t=window.setTimeout(r,e)}}();
